...
We took this output and visualised it on a stacked bar graph, where each chromosome another divided into 1000bp windows and overlapping insertions within these windows are stacked on-top one another, showing the cumulative frequency of the insertion across all replicates.
...
```
Then we tried it again without filtering using the aforementioned python script.
