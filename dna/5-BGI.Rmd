...
Unfortunately, the two lines used for the original PAL generation (replicates 1 & 5 above), were the two lines with the lowest amount of fixation of all the lines assessed. This led us to restart the PAL lines, this time using the two best lines we identified above (d.mel replicate 2 and d.sim replicate 2).
