---
title: "1 - Invaded-inbred lines DNA-seq analysis"
...
After converting to pngs, this provided us with the following DeviaTE plots for each of the lines assessed ()
...
Note that three of the lines are missing (17, N2 and 22), for line 17, we believe that this line was at some point contaminated with d.mel, as it has the same insertion coverage as many of the d.mel lines.
